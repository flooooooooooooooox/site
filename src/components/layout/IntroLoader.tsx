    ...
    <AnimatePresence>
      {show && (
        <motion.div
          key="intro"
          initial={{ opacity: 1 }}
          exit={{ opacity: 0, scale: 1.08, filter: "blur(10px)", transition: { duration: 0.7, ease: [0.65, 0, 0.35, 1] } }}
          aria-hidden
          style={{
        ...
        >
          ...
          <motion.svg
            ...
            transition={{ duration: 2.05, times: [0, 0.55, 0.85, 1], ease: "easeInOut" }}
          ...
          >
            {PATHS.map((p, i) => (
              <motion.path
                ...
                transition={{
                  pathLength: { duration: p.dur, delay: p.delay, ease: [0.45, 0, 0.25, 1] },
          ...
          <span style={{ display: "inline-flex", overflow: "hidden" }}>
            {"Cirrion".split("").map((ch, i) => (
              <motion.span
                ...
                transition={{ delay: 1.45 + i * 0.055, duration: 0.45, ease: [0.16, 1, 0.3, 1] }}
                style={{
