...
const SECTIONS: { label: string; rows: Row[] }[] = [
  {
    ...
    rows: [
      ...
      { feature: "Modèles de devis réutilisables sur l'app web", floxia: true,   obat: true,       sage: true,       ebp: true  },
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Pointage sur site (QR code + GPS)",       floxia: true,       obat: false,      sage: false,      ebp: false },
      { feature: "Photos imposées dans l'app (anti-galerie)", floxia: true,     obat: false,      sage: false,      ebp: false },
      { feature: "Espace client : suivi en temps réel",     floxia: true,       obat: false,      sage: false,      ebp: false },
