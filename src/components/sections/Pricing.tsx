...
const PLANS = [
  {
    ...
    features: [
      ...
      "Tarification produit modifiable",
    ...
    details: [
      ...
      {
        category: "Tarification & données",
        items: [
          "Tarification produit : création et modification de vos tarifs et prestations",
          "Catalogue et données de référence éditables à tout moment",
          "Coordonnées & conformité : informations légales, SIREN, TVA, IBAN",
          "Mentions obligatoires reprises automatiquement sur vos documents",
          "Recherche globale : un seul champ pour clients, devis, factures et chantiers",
        ],
      },
    ...
    details: [
      ...
      },
      {
        ...
        items: [
          ...
          "Temps comparés entre intervenants : les plus performants ressortent",
          ...
          "Contrat de travail déposé et signé électroniquement par le salarié",
          "Avenants et attestations signés de la même façon, archivés horodatés",
        ],
      },
      {
