...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Photo background */}
      <img src="/chantier1.webp" alt="" fetchPriority="high" decoding="async" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", zIndex: 0 }} />
      {/* Dark overlay */}
