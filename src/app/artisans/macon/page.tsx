  ...
  return (
    <>
      ...
      <TradeLanding
        ...
        intro="Maçon, entreprise de gros œuvre ou spécialiste du ravalement : vos chantiers sont souvent longs et complexes, avec une paperasse qui s'accumule. Floxia centralise devis, factures d'acompte, facture finale et PV de réception dans un seul outil, accessible depuis votre téléphone sur le chantier."
        features={[
          ...
          { title: "Acompte et facture finale automatiques", desc: "Facture d'acompte générée à la signature du devis, facture finale en fin de chantier — Floxia enchaîne les étapes sans que vous y pensiez." },
          { title: "TVA gros œuvre au choix", desc: "10% pour les travaux de rénovation sur existant, 20% pour le neuf, 5,5% pour les travaux d'isolation. Vous choisissez le taux sur chaque ligne, Floxia l'applique sur le devis." },
          { title: "Gestion des équipes", desc: "Gérez vos équipes, les plannings et les heures de vos salariés depuis le tableau de bord FloxiaOS." },
          { title: "PV de réception automatisé", desc: "En fin de chantier, Floxia génère et envoie le PV de réception signé électroniquement." },
        ...
        useCases={[
          "Extension de maison 40m² : devis en plusieurs lots (terrassement, fondations, élévation, chape), facture d'acompte à la signature, facture finale à la réception — tout géré par Floxia.",
