...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://florianai.fr/artisans/macon",
  },
  alternates: { canonical: "https://florianai.fr/artisans/macon" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Maçon", item: "https://florianai.fr/artisans/macon" },
  ],
};
