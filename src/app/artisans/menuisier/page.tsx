...
export const metadata: Metadata = {
  title: "Logiciel devis menuisier WhatsApp — Floxia | ERP IA Bâtiment",
  description:
    "Logiciel de devis et facturation pour menuisiers. Créez vos devis menuiserie depuis WhatsApp ou sur l'application Floxia ERP : fenêtres, portes, agencement, e-facturation 2026.",
