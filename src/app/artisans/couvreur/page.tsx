...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Devis toiture depuis WhatsApp ou sur l'application Floxia ERP. Couverture, zinguerie, isolation — TVA automatique.",
  ...
  return (
    <>
      ...
      <TradeLanding
        ...
        intro="Couvreur, charpentier ou zingueur : vos chantiers exigent des métrés précis et des interventions souvent urgentes après un sinistre. Floxia vous permet de générer un devis toiture par message vocal depuis WhatsApp, ou via des pré-modèles IA sur l'application, en intégrant la bonne TVA et vos prix au m²."
        features={[
          { title: "Devis toiture par vocal", desc: "Dictez la surface et les ouvrages — tuiles, ardoises, zinguerie, isolation — et recevez le devis PDF en 3 min." },
          ...
          { title: "TVA rénovation automatique", desc: "5,5% pour l'isolation de toiture, 10% en rénovation, 20% pour le neuf. Appliqué automatiquement." },
        ...
        useCases={[
          "Réfection complète d'une toiture 120m² : devis avec dépose, charpente, couverture tuiles, zinguerie — généré par vocal après le métré.",
          "Isolation de combles par l'extérieur (sarking) : devis TVA 5,5%, attestation, prêt en quelques minutes sur l'application.",
          "Intervention d'urgence après tempête : devis de bâchage et réparation envoyé sur place au client par WhatsApp.",
          "Pose de gouttières en zinc : devis détaillé avec métré linéaire et finitions.",
        ]}
