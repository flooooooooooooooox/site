...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://www.florianai.fr/artisans/couvreur",
  },
  alternates: { canonical: "https://www.florianai.fr/artisans/couvreur" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Couvreur", item: "https://www.florianai.fr/artisans/couvreur" },
  ],
};
  ...
  return (
    <>
      ...
      <TradeLanding
        ...
        closing="De la petite réparation à la réfection complète, Cirrion accélère vos devis de couverture et de charpente. Vous répondez plus vite aux clients, surtout en situation d'urgence où la réactivité fait la différence."
        relatedTrades={[
