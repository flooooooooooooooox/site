  ...
  return (
    <>
      ...
      <TradeLanding
        ...
        intro="Peintre en bâtiment, spécialiste du ravalement ou décorateur d'intérieur : vous jonglez entre les visites de chantier et la rédaction des devis. Vous dictez la prestation par vocal, Floxia génère un devis PDF professionnel avec vos prix du catalogue, depuis votre téléphone, en sortie de visite."
        features={[
          { title: "Devis peinture par vocal en 3 min", desc: "Dictez la prestation par vocal — ravalement, rénovation intérieure, décoration — Floxia génère le devis PDF avec vos prix du catalogue." },
          { title: "Pré-modèles de devis sur l'app", desc: "Sur l'application Floxia ERP, l'IA propose des pré-modèles de devis peinture prêts à personnaliser avec vos prestations types." },
          { title: "TVA peinture au choix", desc: "10% pour la rénovation intérieure et ravalement de résidence principale, 20% pour le neuf. Vous choisissez le taux sur chaque ligne, Floxia l'applique sur le devis." },
