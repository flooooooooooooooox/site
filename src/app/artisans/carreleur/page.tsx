...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Devis carrelage depuis WhatsApp ou sur l'application Floxia ERP. Faïence, sol, terrasse — devis vocal en 3 minutes.",
  ...
  return (
    <>
      ...
      <TradeLanding
        ...
        intro="Carreleur, mosaïste ou poseur de revêtements : vos journées se passent sur les chantiers, pas derrière l'administratif. Floxia génère vos devis carrelage par message vocal depuis WhatsApp, ou via des pré-modèles IA sur l'application, avec vos prix du catalogue et la TVA de votre choix sur chaque ligne."
        features={[
          { title: "Devis carrelage par vocal", desc: "Dictez la prestation — sol, murs, faïence — Floxia génère le devis en 3 min avec vos prix du catalogue." },
          { title: "Pré-modèles de devis sur l'app", desc: "Sur l'application Floxia ERP, des pré-modèles de devis carrelage prêts à personnaliser avec vos prestations types." },
          ...
          { title: "TVA rénovation au choix", desc: "10% pour la rénovation, 20% pour le neuf. Vous choisissez le taux sur chaque ligne, Floxia l'applique sur le devis." },
        ...
        closing="Vous dictez la prestation par vocal, Floxia génère le devis avec vos prix du catalogue, fourniture comme pose. Vos devis carrelage sont prêts en quelques minutes, du chantier comme du bureau."
        relatedTrades={[
