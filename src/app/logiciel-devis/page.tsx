...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://floxia.fr/logiciel-devis" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Logiciel de devis", item: "https://floxia.fr/logiciel-devis" },
  ],
};
    ...
    <main style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "60rem", margin: "0 auto", padding: "8rem 6vw 6rem" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-nunito)", fontWeight: 900, fontSize: "clamp(1.8rem,4vw,2.8rem)", color: "var(--text)", lineHeight: 1.12, letterSpacing: "-0.03em", marginBottom: "1.2rem" }}>
          Logiciel de devis bâtiment <span style={{ color: "#F5C842" }}>par métier et par ville</span>
        </h1>
          ...
          {METIERS.map((m) => (
            <div key={m.slug} style={{ padding: "1.1rem 1.3rem", borderRadius: "1rem", border: "1px solid rgba(var(--surface-rgb),0.08)", background: "rgba(var(--surface-rgb),0.02)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                ...
                <Link href={`/artisans/${m.slug}`} style={{ color: "#F5C842", fontSize: ".78rem", fontWeight: 600, textDecoration: "none", marginTop: "0.2rem" }}>
                  Voir tout →
                </Link>
              </div>
            </div>
        ...
        <div style={{ padding: "2.5rem", borderRadius: "1.5rem", background: "rgba(245,200,66,0.05)", border: "1px solid rgba(245,200,66,0.18)", textAlign: "center" }}>
