...
export const metadata: Metadata = {
  title: "Alternative à Sage : logiciel devis & facture bâtiment IA — Floxia",
  description:
    "Une alternative à Sage plus simple pour les artisans du bâtiment : devis WhatsApp, IA, e-facturation 2026, pré-modèles de devis. Comparatif Floxia vs Sage.",
  keywords: ["alternative Sage", "Sage bâtiment avis", "logiciel comme Sage", "remplacer Sage artisan", "concurrent Sage"],
  openGraph: {
    title: "Alternative à Sage — Floxia pour artisans du bâtiment",
  ...
  return (
    <>
      ...
      <AlternativePage
        competitor="Sage"
        badge="Alternative"
        title="Floxia, l'alternative à Sage pour les artisans du bâtiment"
        intro="Sage est une référence de la gestion d'entreprise, mais ses solutions sont souvent surdimensionnées et coûteuses pour un artisan ou une petite PME du bâtiment. Floxia offre une alternative ciblée sur vos besoins réels : devis, factures, relances et accueil client, le tout automatisé par l'IA et utilisable depuis WhatsApp."
        whyTitle="Pourquoi Floxia est une meilleure alternative à Sage pour le bâtiment"
        whyParagraphs={[
          ...
          "Floxia se concentre sur le quotidien d'un professionnel du bâtiment : générer un devis depuis le terrain par vocal WhatsApp, relancer automatiquement, encaisser plus vite. Pour la comptabilité, Floxia exporte vos données en un clic vers votre expert-comptable. C'est l'alternative à Sage qui correspond à votre métier, sans payer pour des modules que vous n'utiliserez jamais.",
        ]}
        rows={[
        ...
        forWhom="Floxia est l'alternative à Sage pour les artisans et PME du bâtiment qui n'ont pas besoin d'un ERP comptable complet, mais d'un outil simple et intelligent pour gérer devis, factures et relations clients au quotidien."
        others={[
