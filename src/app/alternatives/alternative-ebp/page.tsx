...
export const metadata: Metadata = {
  title: "Alternative à EBP : logiciel devis bâtiment moderne et IA — Floxia",
  description:
    "Une alternative à EBP plus moderne pour artisans du bâtiment : devis WhatsApp, IA, e-facturation 2026, pré-modèles de devis. Comparatif Floxia vs EBP.",
  keywords: ["alternative EBP", "EBP bâtiment avis", "logiciel comme EBP", "remplacer EBP", "concurrent EBP artisan"],
  openGraph: {
    title: "Alternative à EBP — Floxia, le logiciel devis IA",
  ...
  return (
    <>
      ...
      <AlternativePage
        competitor="EBP"
        badge="Alternative"
        title="Floxia, l'alternative moderne à EBP Bâtiment"
        intro="EBP Bâtiment est un logiciel de gestion installé chez de nombreux artisans, mais son interface et son approche restent classiques. Floxia propose une alternative résolument moderne : créez vos devis par message vocal sur WhatsApp ou via des pré-modèles IA, et laissez l'intelligence artificielle gérer relances et accueil client."
        whyTitle="Pourquoi passer d'EBP à Floxia"
        whyParagraphs={[
        ...
        forWhom="Floxia est l'alternative à EBP pour les artisans du bâtiment qui veulent un outil mobile, intelligent et sans saisie fastidieuse. Si vous passez plus de temps sur les chantiers qu'au bureau, Floxia est fait pour vous."
        others={[
