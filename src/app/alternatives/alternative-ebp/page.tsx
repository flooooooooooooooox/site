  ...
  return (
    <>
      ...
      <AlternativePage
        ...
        intro="EBP Bâtiment est un logiciel de gestion installé chez de nombreux artisans, mais son interface et son approche restent classiques. Cirrion propose une alternative résolument moderne : créez vos devis par message vocal sur WhatsApp ou via vos modèles de devis, et laissez l'intelligence artificielle gérer relances et accueil client."
