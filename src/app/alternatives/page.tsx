...
export const metadata: Metadata = {
  title: "Alternatives aux logiciels de devis bâtiment — Comparatifs Floxia",
  description:
    "Floxia comparé aux principaux logiciels de devis et facturation du bâtiment : Obat, Batigest, Sage, EBP. Découvrez quelle solution choisir pour votre entreprise.",
  ...
  openGraph: {
    title: "Alternatives & comparatifs logiciels devis bâtiment — Floxia",
    description: "Floxia comparé à Obat, Batigest, Sage, EBP. Quelle solution de devis et facturation choisir ?",
...
const ALTS = [
  { href: "/alternatives/floxia-vs-obat", title: "Floxia vs Obat", desc: "Devis en ligne et IA : le comparatif complet entre Floxia et Obat." },
