...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://floxia.fr/ressources/devis-signe-valeur-legale" },
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Devis signé valeur légale", item: "https://floxia.fr/ressources/devis-signe-valeur-legale" },
  ],
};
