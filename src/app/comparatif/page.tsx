...
export const metadata: Metadata = {
  ...
  description:
    "Comparez Cirrion aux logiciels bâtiment Obat, Sage et EBP : devis par vocal WhatsApp, agent IA 24h/24, relances automatiques, e-facturation 2026. 26 critères comparés.",
  keywords: [
    "Cirrion vs Obat",
    "alternative Obat",
